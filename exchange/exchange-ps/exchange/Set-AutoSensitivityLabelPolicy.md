...
### -AutoEnforceAfter
The AutoEnforceAfter parameter allows you to configure your policy to be automatically turned on after set amount of time in simulation. This period will restart each time the policy is modified while in simulation. 
